...
function readonlyPadInit() {
    ...
    this.hooks = ['docBarDropdownsPad', 'collabServerUserChanges', 'collabServerClientMessage', 'collabServerApplyMissedChanges', 'isWritingToPadAllowed'];
    ...
    this.isWritingToPadAllowed = hooks.isWritingToPadAllowed;
